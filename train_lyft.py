...
scene_centroid_y = 2.0 # down this many meters
...
def run_model(model, loss_fn, d, device='cuda:0', sw=None):
    ...
    # utils.basic.print_stats('xyz_cam0[:,:,0]', xyz_cam0[:,:,0]) 
    # utils.basic.print_stats('xyz_cam0[:,:,1]', xyz_cam0[:,:,1]) 
    # utils.basic.print_stats('xyz_cam0[:,:,2]', xyz_cam0[:,:,2]) 
